...
for TASK in "${TASKS[@]}"; do
    ...
    LOG_DIR="eval_logs/simpler_env/knn_bbox_zero_NOcopyobs_${knn}_ah_${action_horizon}_candidates_${n_candidates}/$NAME"
    ...
    gr00t/eval/sim/SimplerEnv/simpler_uv/.venv/bin/python gr00t/eval/rollout_policy_nocopy.py \
        --algo "knn" \
