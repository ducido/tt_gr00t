...
for TASK in "${TASKS[@]}"; do
    ...
    LOG_DIR="eval_logs/google_simpler_env/knn_${knn}_motion_setC_inA_bbox_zero_m_${m_motion_in_B}_ah_${action_horizon}_candidates_${n_candidates}/$NAME"
