...
for TASK in "${TASKS[@]}"; do
    ...
    LOG_DIR="eval_logs/gg_robot/knn_${knn}_topK_${top_k}_long_ah_${long_ah}_motion_ah_${action_horizon}_candidates_${n_candidates}_nenvs_${N_envs}_3nd/$NAME"
    ...
    gr00t/eval/sim/SimplerEnv/simpler_uv/.venv/bin/python gr00t/eval/rollout_policy.py \
        --algo "knn_topK_long_motion_neg_prompt" \
