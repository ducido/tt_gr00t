...
##################################################################
# Change Object from RT-1
##################################################################


@register_env("PutCokeCanInBasketScene-v0", max_episode_steps=120)
class PutCokeCanInBasketScene(PutEggplantInBasketScene):
    def __init__(self, **kwargs):
        ...
        super(PutEggplantInBasketScene, self).__init__(
            source_obj_name=source_obj_name,
            target_obj_name=target_obj_name,
            xy_configs=xy_configs,
            quat_configs=quat_configs,
    ...
    def get_language_instruction(self, **kwargs):
        return "put coke can into yellow basket"
